...
//        Musician m1 = new Musician("Alan", 21, "trombone", "keyboards", "Vox");
        /**
         * after Musician class made abstract:
         * 1. we may no longer instantiate a Musician object type (RHS)
         * RHS has to be one of MUSICIAN'S CONCRETE SUBCLASSES
         */
        Musician m1 = new SessionMusician("Alan", 21, 100.00, "trombone", "keyboards", "Vox");
...
//            System.out.printf("Band member: %s\n", member.getPayRate());
        ...
        /**
         * make a virtual musician:
         */
        Musician vm1 = new VirtualMusician("Drummer Gary", "GarageBand", 21, "drums, percussion, loops");
